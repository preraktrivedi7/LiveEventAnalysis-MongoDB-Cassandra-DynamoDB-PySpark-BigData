#importing packages and connecting mongoDB and Python
...
class StdOutListener(StreamListener):
    ...
    def on_data(self, data):
        ...
        tweet = {'id':tweet_id, 'username':username, 'followers':followers, 'text':text, 'hashtags':hashtags 'created':dt}
